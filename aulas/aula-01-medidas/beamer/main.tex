...
%
% ATENÇÃO: a versão corrente e completa desta aula é a apresentação web, em
% aulas/aula-01-medidas/index.html. Este arquivo é a versão Beamer original,
% mantida como registro; ela NÃO contém os tópicos acrescentados depois
% (divisão, outras operações, erro relativo percentual, propagação de erros,
% Exemplos 8 a 14 e o tratamento estatístico completo do Exemplo 11).
%
